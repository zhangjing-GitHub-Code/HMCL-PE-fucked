...
code=lzy.upload_file("./HMCLPE-Commit{}-zhangjing.apk".format(cmtid),5347978,uploaded_handler=handler)
print("List in lanzou/HMCLPE: \033[35m",lzy.get_file_list(5347978),end='\033[0m\n')
print("Return code:",code)
#list dir : print(os.popen("ls").read())
if code!=LanZouCloud.SUCCESS:
    raise RuntimeError("Return code wrong: something will wrong.")
